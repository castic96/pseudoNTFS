/*
    ...
    Tento modul se stará o práci s datovým souborem pro uložení
    souborového systému pseudoNTFS. Stará se o jeho vytvoøení, uložení
...
/* ____________________________________________________________________________
    ...
    Zformátuje soubor uložený v `path_name' na poèáteèní hodnoty. 
...
/* ____________________________________________________________________________
    ...
    Naète datové struktury ze souboru, který je uložený v `path_name'.
