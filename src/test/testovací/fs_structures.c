...
TESTOVÁNÍ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ____________________________________________________________________________
*/
mft_item *init_mft_item_1(int32_t data_start_address) {
	
	mft_item *new_mft_item_root = (mft_item *) calloc(1, sizeof(mft_item));
	
	new_mft_item_root->uid = 2;
	...
	strcpy(new_mft_item_root->item_name, "a");
	
	new_mft_item_root->fragments[0].fragment_start_address = data_start_address + CLUSTER_SIZE;
	new_mft_item_root->fragments[0].fragment_count = 1;
	
	return new_mft_item_root;
}
mft_item *init_mft_item_2(int32_t data_start_address) {
	
	mft_item *new_mft_item_root = (mft_item *) calloc(1, sizeof(mft_item));
	
	new_mft_item_root->uid = 3;
	new_mft_item_root->type = 0;
	new_mft_item_root->item_order = 1;
	new_mft_item_root->item_order_total = 1;
	new_mft_item_root->item_size = CLUSTER_SIZE;
	strcpy(new_mft_item_root->item_name, "b");
	
	new_mft_item_root->fragments[0].fragment_start_address = data_start_address + CLUSTER_SIZE + CLUSTER_SIZE;
	new_mft_item_root->fragments[0].fragment_count = 1;
	
	return new_mft_item_root;
}
mft_item *init_mft_item_3(int32_t data_start_address) {
	
	mft_item *new_mft_item_root = (mft_item *) calloc(1, sizeof(mft_item));
	
	new_mft_item_root->uid = 4;
	new_mft_item_root->type = 1;
	new_mft_item_root->item_order = 1;
	new_mft_item_root->item_order_total = 1;
	new_mft_item_root->item_size = CLUSTER_SIZE;
	strcpy(new_mft_item_root->item_name, "c");
	
	new_mft_item_root->fragments[0].fragment_start_address = data_start_address + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE;
	new_mft_item_root->fragments[0].fragment_count = 1;
	
	return new_mft_item_root;
}
mft_item *init_mft_item_4(int32_t data_start_address) {
	
	mft_item *new_mft_item_root = (mft_item *) calloc(1, sizeof(mft_item));
	
	new_mft_item_root->uid = 5;
	new_mft_item_root->type = 1;
	new_mft_item_root->item_order = 1;
	new_mft_item_root->item_order_total = 1;
	new_mft_item_root->item_size = CLUSTER_SIZE;
	strcpy(new_mft_item_root->item_name, "d");
	
	new_mft_item_root->fragments[0].fragment_start_address = data_start_address + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE;
	new_mft_item_root->fragments[0].fragment_count = 1;
	
	return new_mft_item_root;
}
mft_item *init_mft_item_5(int32_t data_start_address) {
	
	mft_item *new_mft_item_root = (mft_item *) calloc(1, sizeof(mft_item));
	
	new_mft_item_root->uid = 6;
	new_mft_item_root->type = 2;
	new_mft_item_root->item_order = 1;
	new_mft_item_root->item_order_total = 1;
	new_mft_item_root->item_size = CLUSTER_SIZE;
	strcpy(new_mft_item_root->item_name, "e");
	
	new_mft_item_root->fragments[0].fragment_start_address = data_start_address + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE + CLUSTER_SIZE;
	new_mft_item_root->fragments[0].fragment_count = 1;
...
mft_item **init_mft_item_array(int mft_item_count, int32_t data_start_address) {
	...
	new_mft_item_arr[1] = init_mft_item_1(data_start_address);
	new_mft_item_arr[2] = init_mft_item_2(data_start_address);
	new_mft_item_arr[3] = init_mft_item_3(data_start_address);
	new_mft_item_arr[4] = init_mft_item_4(data_start_address);
	new_mft_item_arr[5] = init_mft_item_5(data_start_address);
	
	
	for (i = 6; i < mft_item_count; i++) {
